            ...
            <div class="col-md-12">
                <section class="boxs">
                    <div class="boxs-header">
                        <h3 class="custom-font hb-blue"><strong>Change of Partnership</strong></h3>
                    </div>
                    <div class="boxs-body">
                                ...
                                <?php if (!empty($change_of_names)) { ?>
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo base_url(); ?>make_payment/make_payment_partnership/<?php echo $data->id; ?>"><i class="fa fa-eye"></i></a>
                                            </td>
                                        </tr>
                                        <?php $cntr++;
                                    } ?>
