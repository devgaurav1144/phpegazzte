            ...
            <div class="col-md-12">
                <section class="boxs">
                    <div class="boxs-header">
                        <h3 class="custom-font hb-blue"><strong>Change of Gender</strong></h3>
                                ...
                                <?php if (!empty($change_of_genders)) { ?>
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="center">
                                                <a href="<?php echo base_url(); ?>make_payment/make_payment_gender/<?php echo $data->id; ?>"><i class="fa fa-eye"></i></a>
                                            </td>
                                        </tr>
                                        <?php $cntr++;
                                    } ?>
