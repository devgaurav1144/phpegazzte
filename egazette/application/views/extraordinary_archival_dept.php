...
<html   class="no-js">
    ...
    <body class="home-body">
        ...
        <section class="inner-banner">
            <div class="container">
                <h1>Extraordinary Archival Gazette of <em><?php echo $department->department_name; ?></em></h1>
            </div>
        </section>
                    ...
                    <div class="col-lg-12">
                        <div class="breadcumb">
                            <ul>
                                ...
                                <li>Extraordinary Archival Gazette Department</li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 e-margin fadeInBottom">
                        <div class="infographic-section media-section">
                            ...
                            <div class="content-part">
                                <div class="row">
                                    <?php echo form_open('extraordinary_archival_dept_search', array('method' => 'post', 'class' => 'row', 'id' => 'filter', 'name' => 'filter')); ?>
                                        
                                        <input type="hidden" id="check" name="check" value="1"/>
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 marg ext" hidden>
                                            <div class="search-gazette">
                                                <div class="form-group">
                                                    <label class="margin-bottom">Department </label>
                                                    <input type="text" class="form-control" name="dept_id" id="dept_id" value="<?php echo $department->id; ?>" readonly>
                                                    ...
                                                    <?php foreach ($gazettes as $gazette) { ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="<?php echo site_url('Archival_ControllerEW/view_gazette/' . $gazette->id); ?>" target="_blank"><i class="fa fa-file-pdf-o"></i></a>
                                                            </td>
                                                        </tr>
                                                        <?php
                                                        $cntr++;
