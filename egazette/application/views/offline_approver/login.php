...
<html class="no-js" lang="">
    <head>
        ...
        <title>:: E-Gazette - Offline Approver Login ::</title>
                    ...
                    <div class="row">
                        <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 text-center">
                            <div class="card card-signup">
                                <?php echo form_open('offline_payment_users/login_offline', array('id' => 'login_form', 'method' => 'post', 'class' => 'form')); ?>
                                <div class="header header-primary text-center">
                                    <a href="<?php echo base_url(); ?>"><img width="270px;" src="<?php echo base_url(); ?>assets/frontend/images/logo.png"/></a>
                                </div>
                                <h3 class="mt-0">Sign In (Offline Approver)</h3>
                                <?php if ($this->session->flashdata('success')) { ?>
                                    <span class="success_error"><?php echo $this->session->flashdata('success'); ?></span>
                                <?php } ?>
                                ...
                                <div class="content">
                                    <div class="form-group mobile_number">
                                        <label class="field-head">Login ID <span class="mandatory">*</span></label>
                                        <input type="text" name="mobile" id="mobile" class="form-control underline-input" placeholder="Enter login ID" required autocomplete="off" value="" maxlength="6">
                                    ...
                                    <div class="form-group mobile_number">
                                        ...
                                        <input type="password" name="password" id="password" class="form-control underline-input" placeholder="Enter password" required autocomplete="off" maxlength="16" value=""/>
                                        <input type="hidden" name="enc_pwd" id="enc_pwd" value=""/>
                                        <a href="<?php echo base_url(); ?>igr_user/forgot_password" class="btn btn-wd forgot-p">Forgot Password?</a>
                                    ...
                                    <div class="footer text-center">
                                        <input type="submit" class="btn btn-info btn-raised w-100" name="submit_btn" value="Login"/>
                                    </div>
                                           
                                    <!--<div class="text-center text-muted content-divider mb-3">
										<span class="px-2">Don't have an account?</span>
									</div>-->
<!--                                    <a href="<?php echo base_url(); ?>applicants_login/registeration" class="btn btn-wd">Register</a><br>
                                        -->                                    <a href="<?php echo base_url(); ?>applicants_login" class="btn btn-wd btn btn-default btn-raised w-100">Applicant's Dashboard</a>
            ...
            $("#login_form").validate({
                ...
                messages: {
                    mobile: {
                        ...
                        maxlength: 'Login ID should be maximum 6 characters'
                    },
                    password: {
