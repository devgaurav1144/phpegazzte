        ...
        <div class="row">
            <div class="col-md-12">
                <section class="boxs">
                    ...
                    <h3 class="custom-font hb-blue"><strong>Offline Payment List</strong></h3>
                    </div>
                    <div class="boxs-body">
                            ...
                            <tbody>
                                <?php if (!empty($offline_pay_list)) { ?>
                                    ...
                                    ?>
                                        ...
                                        foreach ($offline_pay_list as $data) { ?>
										<?php echo form_open("offline_payment_users/offline_payment_list", array("method" => "POST", "id" => "form1", "name" => "form1")); ?>
                                        <tr>
                                            <td><?php echo $cntr; ?></td>
                                            <td>Extraordinary</td>
					...
					<?php if(!empty($user_details)) { ?> 
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-9">
								...
								<?php echo form_open("offline_payment_users/offline_payment_list", array("method" => "POST", "id" => "form_offline_pay", "name" => "form_offline_pay")); ?>
								<tbody>
									<tr>
									  <td>Name</td> 
