                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 media-section fadeInBottom">
                                <div class="infographic-section">
                                    <h3 class="head-section teal">Change of Partnership
<!--                                        <div class="search-box maf">
                                    ...
                                    <div class="hole-border">
                                        <table class="table table-bordered table-hover table-striped recent-gazette">
                                            <thead>
                                                <tr>
                                                    <th class="dep-width">Applicant Name</th>
                                            ...
                                            <tbody>
                                                <?php if (!empty($cops)) { ?>
                                                    <?php foreach ($cops as $cop) { ?>
                                                        <tr>
                                                            <td><?php echo $cop->name.' '.$cop->father_name; ?></td>
                                                            <td>Change of Partnership</td>
                                                            <td><?php echo date("Y-m-d", strtotime($cop->created_at)); ?></td>
                                                            <td><a href="<?php echo $cop->press_signed_pdf; ?>" target="_blank"><span class="download"><img src="<?php echo base_url(); ?>assets/frontend/images/download.png"/></span></a></td>
                                                        </tr>
                                                    <?php } ?>
                                                <?php } else { ?>
                                                    <tr>
