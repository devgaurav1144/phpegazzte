...
<section id="content">
    <div class="page page-forms-validate">
        <ol class="breadcrumb">
            ...
            <li class="active">Edit C&T User</li>
        </ol>
        <!-- row -->
        <div class="row">
            <div class="col-md-12">
                <section class="boxs">
                    <div class="boxs-header">
                        <h3 class="custom-font hb-blue"><strong>Edit C&T User</strong></h3>
                    </div>
                    
                    <?php echo form_open('', array('name' => 'form1',  'id' => 'form1', 'method' => 'post')); ?>
                    
                     <input type="hidden" name="c_t_id" id="c_t_id" value="<?php echo $c_t_id; ?>">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <select name="ver_app" id="ver_app" class="form-control" required="">
                                        ...
                                        <option value="Verifier" <?php if($c_and_t->verify_approve == 'Verifier') { echo "selected";}  ?> >Verifier</option>
                                        <option value="Approver" <?php if($c_and_t->verify_approve == 'Approver') { echo "selected";}  ?> >Approver</option>
                                        <option value="Processor" <?php if($c_and_t->verify_approve == 'Processor') { echo "selected";}  ?> >Processor</option>
                                    </select>
                             ...
                             <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control alpha_only" autocomplete="off" value="<?php echo $c_and_t->name; ?>" minlength="4" maxlength="50">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="username" id="username" class="form-control alpha_only"  autocomplete="off"  value="<?php echo $c_and_t->user_name; ?>""  minlength="4" maxlength="50">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="email" id="email" class="form-control"  autocomplete="off" value="<?php echo  $c_and_t->email; ?>"  minlength="6" maxlength="96">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="mobile" id="mobile" class="form-control number_only"  autocomplete="off" value="<?php echo $c_and_t->mobile; ?>" minlength="10" maxlength="10"> 
                                ...
                                <!--<div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="emp_id" id="emp_id" class="form-control" required autocomplete="off" value="<?php //echo $c_and_t->emp_id; ?>" readonly>
                                ...
                                <!--<div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="dob" id="dob" class="form-control report_date"  autocomplete="off" value="<?php //echo date("Y-m-d", strtotime($c_and_t->dob)); ?>">
                                    ...
                                    <select name="module_id" id="module_id" class="form-control" required="">
                                     ...
                                     <?php if(!empty($modules)){ ?>
                                         <?php foreach ($modules as $module){ ?>
                                             <option value="<?php echo $module->id; ?>"  <?php if($c_and_t->module_id == $module->id) { echo "selected";}  ?>  ><?php echo $module->module_name; ?></option>
                                         <?php } ?>
                                     <?php } ?>
                                    </select>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="login_id" id="login_id" class="form-control alpha_only" autocomplete="off" value="<?php echo $c_and_t->login_id; ?>" minlength="4" maxlength="50" readonly>
                                </div>
                            </div>
                        </div>
    ...
    $('#form1').validate({
       ...
       rules: {
        ...
        submitHandler: function (form) {
           ...
           $.ajax({
               type: "POST",
               url: "<?php echo base_url(); ?>Commerce_transport_department/update_candt_users",
