                    ...
                    <div class="row">
                        <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 text-center">
                            <div class="card card-signup">
                                ...
                                <h3 class="mt-0">Forgot Password (C & T User)</h3>
                                ...
                                <?php echo form_open('commerce_transport_department/forgot_password', array('method' => 'post', 'class' => 'form', 'id' => 'otp_form')); ?>    
                                    <div class="content">
                                        ...
                                        <a href="<?php echo base_url(); ?>commerce_transport_department/login_ct" class="btn btn-default btn-raised register_btn btn-wd">Login</a>
                                        <?php echo form_close(); ?>
                                    </div>        
                            </div>
                        </div>
