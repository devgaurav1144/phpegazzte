...
<html class="no-js" lang="">
    <head>
        ...
        <title>:: E-Gazette - Applicant;s Login ::</title>
                    ...
                    <div class="row">
                        <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 text-center">
                            <div class="card card-signup">
                                <?php echo form_open('commerce_transport_department/login_ct', array('id' => 'login_form', 'method' => 'post', 'class' => 'form')); ?>
                                    <div class="header header-primary text-center">
                                        <a href="<?php echo base_url(); ?>"><img width="270px;" src="<?php echo base_url(); ?>assets/frontend/images/uplogo.png"/></a>
                                    </div>
                                    <h3 class="mt-0">Sign In (C & T User)</h3>
                                    ...
                                    <div class="content">
                                        <div class="form-group mobile_number">
                                            ...
                                            <input type="text" name="mobile" id="mobile" class="form-control underline-input" placeholder="Enter login ID" required autocomplete="off" value="" maxlength="20">
                                        ...
                                        <div class="form-group mobile_number">
                                            ...
                                            <a href="<?php echo base_url(); ?>commerce_transport_department/forgot_password" class="btn btn-wd forgot-p">Forgot Password?</a>
            ...
            $("#login_form").validate({
                ...
                messages: {
                    mobile: {
                       ...
                       maxlength: 'Login ID should be maximum 20 characters'
                   },
                   password: {
