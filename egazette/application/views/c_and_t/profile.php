        ...
        <div class="row">
            <div class="col-md-12">
                <section class="boxs">
                    ...
                    <?php echo form_open('commerce_transport_department/profile', array('method' => 'post', 'id' => 'profile_form', 'role' => 'form', 'name' => 'profile_form')); ?>    
                        <div class="boxs-body">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <select name="ver_app" id="ver_app" class="form-control" disabled>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mobile_number">
                                        <label for="name">Select Module: <span class="asterisk">*</span> </label>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    <label for="website">Email:  <span class="asterisk">*</span></label>
                                ...
                                <div class="form-group col-md-6">
                                    <label for="message">Mobile:  <span class="asterisk">*</span></label>
