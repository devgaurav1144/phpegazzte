...
<html class="no-js">
    ...
    <body class="home-body">
        ...
        <section class="inner-banner">
            <div class="container">
                <h1>Extraordinary Gazettes (Surname Change / Partnership Deed Change)</h1>
            </div>
        </section>
                    ...
                    <div class="col-lg-12">
                        <div class="breadcumb">
                            <ul>
                                ...
                                <li>Extraordinary Gazettes (Surname Change / Partnership Deed Change)</li>
                            </ul>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 media-section fadeInBottom">
                                <div class="infographic-section">
                                    <h3 class="head-section teal">Extraordinary Gazettes (Surname Change / Partnership Deed Change)
<!--                                        <div class="search-box maf">
                                                ...
                                                <?php if (!empty($gazette_list)) { ?>
                                                    <?php foreach ($gazette_list as $gazette) { ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo date("Y-m-d", strtotime($gazette->issue_date)); ?></td>
                                                            <td><a href="<?php echo $gazette->press_signed_pdf_path; ?>" target="_blank"><span class="download"><img src="<?php echo base_url(); ?>assets/frontend/images/download.png"/></span></a></td>
                                                        </tr>
                                                    <?php } ?>
                                                <?php } else { ?>
                                                    <tr>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 media-section fadeInScale">
                                <div class="infographic-section links">
                                    ...
                                    <ul id="announcements-vertical-news">
                                        <li><a href="<?php echo base_url(); ?>bills_acts">Bills & Act's</a></li>
