    ...
    <div class="page page-tables-footable">
        ...
        <div class="col-md-15">
                <section class="boxs box_report <?php echo $class ?>" id="show_filter_form">
                    ...
                    <?php echo form_open('applicants_login/published_change_of_name_surname_govt_list', array('method' => 'post','id'=>'search_data', 'autocomplete' => 'off')); ?>
                        <div class="boxs-body">
                            <div class="row">
                ...
                <section class="boxs">
                    <div class="boxs-header filter-with-add">
                        <?php if ($this->session->userdata('is_admin')) { ?>
                                <h3 class="custom-font hb-blue"><strong>Published Change of Name/Surname Details</strong></h3>
                        <?php } else { ?>
                            <h3 class="custom-font hb-blue"><strong>Published Change of Name/Surname Details</strong></h3>
                        <?php } ?>
                        <div class="">
                                        ...
                                        <?php if (!empty($partner_publish)) { ?>
                                            ...
                                            <?php foreach ($partner_publish as $partner) { ?>
                                                <tr>
                                                    ...
                                                    <td class="center">          
                                                            <a href="<?php echo base_url(); ?>applicants_login/view_details_change_name_govt/<?php echo $partner->id; ?>"><i class="fa fa-eye"></i></a>
                                                    </td>
                                                    <td>
...
<script type="text/javascript" nonce="a6b9a780936c8e980939086f618dded2">
    $(document).ready(function(){
        ...
        $('#reset_btn').click(function () { 
            ...
            window.location.href = "<?php echo base_url(); ?>applicants_login/published_change_of_name_surname_govt_list"           
        });
