    ...
    <div class="page page-tables-footable">
        ...
        <div class="b-b mb-10">
            <div class="row">
                <div class="col-sm-12 col-xs-12">
                        <h1 class="h3 m-0">Change of Name/Surname</h1>
        ...
        <div class="col-md-15">
                <section class="boxs box_report">
                    <?php echo form_open('applicants_login/search_change_of_name_surname_govt_list', array('method' => 'post','id'=>'search_data', 'autocomplete' => 'off')); ?>
                        <div class="boxs-body">
                            <div class="row">
