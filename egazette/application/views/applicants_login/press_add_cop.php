                ...
                <section class="boxs">
                    <div class="boxs-header">
                        ...
                        <!--    <div class="action_btn">
                            <a href="<?php echo base_url(); ?>gazette/press_preview" class="btn btn-raised btn-success edit_btn pull-right">Preview</a>
                        </div>-->
                    </div>
                    
                    <?php echo form_open('applicants_login/press_preview', array('name' => "form1", 'role' => "form", 'id' => "dept_gazetee_preview_form", 'enctype' => "multipart/form-data", 'method' => "post")); ?>    
                        <div class="gazette-main">
                            <div class="header-gazette">
                                ...
                                <div class="gazette-nav-bar">
                                    <ul>
                                        <li class="number">
                                            <input type="text" name="sl_no" id="sl_no" class="form-control" required value="<?php echo $sl_no; ?>" placeholder="Number" readonly="" autocomplete="off">
