...
<section id="content">
    <div class="page page-tables-footable">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Change of Gender</li>
        </ol>
        ...
        <div class="col-md-12">
                <section class="boxs box_report <?php echo $class ?>" id="show_filter_form">
                    ...
                    <?php echo form_open('applicants_login/search_for_change_of_gender', array('method' => 'post','id'=>'search_data', 'autocomplete' => 'off')); ?>
                        <div class="boxs-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select name="status" id="status" class="form-control">
                                                ...
                                                <?php if (!empty($total_status)) { ?>
                                                    <?php foreach ($total_status as$gender) { ?>
                                                        <option value="<?php echo$gender->id; ?>" <?php if($status ==$gender->id){ echo 'selected'; } ?> ><?php echo$gender->status_name; ?></option>
                                                    <?php } ?>
                                                <?php } ?>
                                        </select>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-sm-5">
                                <?php if ($this->session->userdata('is_admin')) { ?>
                                    <h3 class="custom-font hb-blue"><strong>Govt. Press Change of Gender Details</strong></h3>
                                <?php } else { ?>
                                    <h3 class="custom-font hb-blue"><strong>Change of Gender Details</strong></h3>
                                <?php } ?>
                            </div>

                            <!-- The below section is pending -->
                            <!-- <div class="col-sm-5">
                                <?php echo form_open('applicants_login/search_for_change_of_gender', array('method' => 'post','id'=>'search_data', 'autocomplete' => 'off')); ?>
                                    <div class="form-group col-sm-4 form-group-select">
                                        ...
                                        <select name="status" id="status" class="form-control">
                                            ...
                                            if (!empty($total_status)) {
                                                ...
                                                foreach ($total_status as $gender) {
                                ...
                                <?php if (!empty($change_of_genders)) { ?>
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="center">
                                                <!-- working on view_details_change_of_gender_c_and_t .... -->
...
<script type="text/javascript" nonce="a6b9a780936c8e980939086f618dded2">
    $(document).ready(function(){
        ...
        $('#reset_btn').click(function () { 
            ...
            window.location.href = "<?php echo base_url(); ?>applicants_login/index_for_change_of_gender"           
        });
