...
<section id="content">
    <div class="page page-tables-footable">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Published Change of Partnership</li>
        </ol>

        <!--Filteration Inputs Data-->
        <?php 
            $app_name = "";
            $file_no = "";
            $notice_date_form = "";
        ...
        <div class="col-md-15">
                <section class="boxs box_report <?php echo $class ?>" id="show_filter_form">
                    ...
                    <?php echo form_open('applicants_login/search_for_published_partnership', array('method' => 'post','id'=>'search_data','autocomplete' => 'off')); ?>
                        <div class="boxs-body">
                            <div class="row">
                                <div class="form-group col-md-4">
                                    <label for="name">Applicant Name </label>
                                    <input type="text" name="app_name" id="app_name" class="form-control" autocomplete="off" value="<?php echo set_value('app_name'); ?>">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" name="file_no" id="file_no" class="form-control" autocomplete="off" value="<?php echo set_value('file_no'); ?>">
                ...
                <section class="boxs">
                    <div class="boxs-header filter-with-add">
                        <?php if ($this->session->userdata('is_admin')) { ?>
                                <h3 class="custom-font hb-blue"><strong>Govt. Press All Published Partnership</strong></h3>
                        <?php } else { ?>
                            <h3 class="custom-font hb-blue"><strong>All Published Partnership</strong></h3>
                        <?php } ?>
                        <div class="">
                                ...
                                <?php if (!empty($change_of_names)) { ?>
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="center">
                                                <a href="<?php echo base_url(); ?>applicants_login/edit_partnership_details/<?php echo $data->id; ?>"><i class="fa fa-eye"></i></a>
                                            </td>
                                        </tr>
                                        <?php $cntr++;
                                    } ?>
...
<script type="text/javascript" nonce="a6b9a780936c8e980939086f618dded2">
    $(document).ready(function(){
        ...
        $('#reset_btn').click(function () { 
            ...
            window.location.href = "<?php echo base_url(); ?>applicants_login/published_partnership"           
        });
        ...
        $('#search_name').click(function(){
            ...
            if (data === "" && data_name === ""&& f_data === "" && t_data === "" ) { 
