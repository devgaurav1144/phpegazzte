            ...
            <div class="col-md-12">
                <section class="boxs">
                    <div class="boxs-header">
                        <h3 class="custom-font hb-blue"><strong>Add Docket</strong></h3>
                    </div>
                    <?php echo form_open('applicants_login/press_preview_change_name_surname', array('name' => "form1", 'role' => "form", 'id' => "dept_gazetee_preview_form", 'enctype' => "multipart/form-data", 'method' => "post")); ?>    
                        <div class="gazette-main">
                            <div class="header-gazette">
                                <!-- <img src="<?php echo base_url(); ?>assets/images/header.jpg"> -->
                                 <h1 style="font-family: 'Poppins'">Uttar Pradesh Gazette</h1>
                                <p class="sub-head"> EXTRAORDINARY <span>PUBLISHED BY AUTHORITY</span></p>
                                <div class="gazette-nav-bar">
                                    <ul class="docker-ul-head">
                                        <li class="number">
                                            <input type="number" name="sl_no" id="sl_no" class="form-control" required value="<?php echo $sl_no; ?>" placeholder="Number"  autocomplete="off">
                                            <?php if (form_error('sl_no')) { ?>
                                                <span class="error"><?php echo form_error('sl_no'); ?></span>
                                            <?php } ?>
                                        </li>
                                        <li class="city">LUCKNOW,</li>
                                        <li class="day">
                                        ...
                                        <li class="month month2">
											...
											<select name="saka_month" id="saka_month" required class="form-control" autocomplete="off">
                                                ...
                                                <option value="CHAITRA" <?php echo set_select('saka_month', 'CHAITRA'); ?>>CHAITRA</option>
												<option value="VAISAKHA" <?php echo set_select('saka_month', 'VAISAKHA'); ?>>VAISAKHA</option>
												<option value="JYAISHTHA" <?php echo set_select('saka_month', 'JYAISHTHA'); ?>>JYAISHTHA</option>
												<option value="ASADHA" <?php echo set_select('saka_month', 'ASADHA'); ?>>ASADHA</option>
												<option value="SRAVANA" <?php echo set_select('saka_month', 'SRAVANA'); ?>>SRAVANA</option>
												<option value="BHADRA" <?php echo set_select('saka_month', 'BHADRA'); ?>>BHADRA</option>
												<option value="ASVINA" <?php echo set_select('saka_month', 'ASVINA'); ?>>ASVINA</option>
												<option value="KARTIKA" <?php echo set_select('saka_month', 'KARTIKA'); ?>>KARTIKA</option>
												<option value="AGRAHAYANA" <?php echo set_select('saka_month', 'AGRAHAYANA'); ?>>AGRAHAYANA</option>
												<option value="PAUSA" <?php echo set_select('saka_month', 'PAUSA'); ?>>PAUSA</option>
												<option value="MAGHA" <?php echo set_select('saka_month', 'MAGHA'); ?>>MAGHA</option>
												<option value="PHALGUNA" <?php echo set_select('saka_month', 'PHALGUNA'); ?>>CHAITRA</option>
											</select>
                                        ...
                                        <li class="month month2">
											<input type="text" name="saka_year" id="saka_year" class="form-control" value="" maxlength="4" placeholder="2017" value="<?php echo set_value('saka_year'); ?>" autocomplete="off">
                            ...
                            <div class="pdf-container">
                                <embed src="<?php echo $details->notice_softcopy_pdf; ?>" type="application/pdf" width="100%" height="650px" internalinstanceid="8">
                            </div>
                            <footer>
                                <div class="line"></div>
                                <!-- <p>Processed and Published by the Directorate of Printing, Stationery and Publication, Uttar Pradesh, Lucknow</p><p></p> -->
                                 <p>Sarojini Naidu Marg, Cantonment, Dhoomanganj,Prayagraj - 211001, Uttar Pradesh, India </p>
                            </footer>
                        </div>
...
<script>
    $(document).ready(function(){
        ...
        $("#dept_gazetee_preview_form").validate({
            rules: {
                issue_date: {
                    required: true
                },
