        ...
        <div class="row">
            <div class="col-md-12">
                <section class="boxs">
                    ...
                    <?php echo form_open('applicants_login/press_preview_change_gender', array('name' => "form1", 'role' => "form", 'id' => "dept_gazetee_preview_form", 'enctype' => "multipart/form-data", 'method' => "post")); ?>    
                        <div class="gazette-main">
                            ...
                            <footer>
                                <div class="line"></div>
                                <p>Processed and Published by the Directorate of Printing, Stationery and Publication, (StateName), Cuttack-10</p><p></p>
                            </footer>
                        </div>
