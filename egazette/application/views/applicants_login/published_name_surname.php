...
<section id="content">
    <div class="page page-tables-footable">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Published Change of Name/Surname</li>
        </ol>
        <!--Filteration--->
        <?php 
            $app_name = "";
        ...
        <div class="col-md-15">
                <section class="boxs box_report <?php echo $class ?>" id="show_filter_form">
                    ...
                    <?php echo form_open('applicants_login/search_for_published_change_of_name_surname', array('method' => 'post','id'=>'search_data', 'autocomplete' => 'off')); ?>
                        <div class="boxs-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" name="file_no" id="file_no" class="form-control" autocomplete="off" value="<?php echo $file_no; ?>" placeholder="XN-0001-2022">
                ...
                <section class="boxs">
                    <div class="boxs-header filter-with-add">
                        <?php if ($this->session->userdata('is_admin')) { ?>
                                <h3 class="custom-font hb-blue"><strong>Govt. Press Published Change of Name/Surname</strong></h3>
                        <?php } else { ?>
                            <h3 class="custom-font hb-blue"><strong>Published Change of Name/Surname</strong></h3>
                        <?php } ?>
                        <div class="">
