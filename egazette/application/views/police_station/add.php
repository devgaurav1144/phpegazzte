        ...
        <div class="row">
            <div class="col-md-12">
                <section class="boxs">
                    ...
                    <h3 class="custom-font hb-blue"><strong>Add Police Station</strong></h3>
                    </div>
                    <?php echo form_open('police_station/add', array('name' => "form1", 'role' => "form", 'id' => "form1", 'method' => "post", 'enctype' => "multipart/form-data")); ?>    
                        <div class="boxs-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4">
                                        <label for="psname">Police Station Name : <span class="asterisk">*</span></label>
                                        <input type="text" name="police_station_name" id="police_station_name" class="form-control" required autocomplete="off">
