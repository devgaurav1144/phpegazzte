        ...
        <div class="b-b mb-10">
            <div class="row">
                <div class="col-sm-6 col-xs-12">
                    <h1 class="h3 m-0">Police Station</h1>
...
<section id="content">
    <div class="page page-tables-footable">
        <ol class="breadcrumb">
            ...
            <li class="active">Police Station</li>
        </ol>
        <!-- bradcome -->
        <?php
            $state_name = "";
            ...
            if(isset($inputs['police_station_name'])){
                $police_station_name = $inputs['police_station_name'];
            }

            if(!empty($state_name) || !empty($district_name) || !empty($police_station_name)){
                $class= "";
            }else{
                $class= "d-none";
            }
        ...
        <div class="">
            <div class="col-md-15">
                <section class="boxs box_report <?php echo $class?>" id="show_filter_form">
                    ...
                    <?php echo form_open('police_station/search_ps', array('method' => 'post','id' => "formsearch",'name' => "formsearch")); ?>
                        <div class="boxs-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" name="police_station_name" id="police_station_name" class="form-control" autocomplete="off" value="<?php echo set_value('police_station_name'); ?>">
            ...
            <div class="col-md-12">
                <section class="boxs">
                    <div class="boxs-header filter-with-addd">
                        <h3 class="custom-font hb-blue"><strong>Police Station</strong></h3>
                        ...
                        <a href="<?php echo base_url(); ?>police_station/add" class="btn-bg btn btn-success btn-right-align">Add</a>
                    </div>
                    <div class="boxs-body">
                        ...
                        <table id="searchTextResults" data-filter="#filter" data-page-size="5" class="footable table table-custom">
                            ...
                            <tbody>
                                <?php if (!empty($police_stations)) { ?>
                                    ...
                                    ?>
                                    <?php foreach ($police_stations as $pstation) { ?>
                                        <tr>
                                            <td><?php echo $cntr; ?></td>
                                            <td><?php echo $pstation->police_station_name;?></td>
                                            <td><?php echo $pstation->district_name;?></td>
                                            <td><?php echo $pstation->state_name;?></td>
                                            <td>
                                                <div class="status_change togglebutton" id="<?php echo $pstation->id; ?>" title="<?php echo $pstation->status; ?>">
                                                    <label><input type="checkbox" <?php echo ($pstation->status == 1) ? "checked" : ""; ?>></label>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="btn-group mr5 btn-grp-mr">
                                                    ...
                                                    <ul class="dropdown-menu" role="menu">
                                                        <li><a href="<?php echo base_url();?>police_station/edit/<?php echo $pstation->id; ?>">Edit</a></li>
                                                        <li class="delete_id" id="<?php echo $pstation->id; ?>"><a href="javascript:void(0);" onclick="deleteFunction(<?php echo $pstation->id; ?>)">Delete<div class="ripple-container"></div></a></li>
                                                    </ul>
                                                </div>
                                            </td>
                                        </tr>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-primary ps_id">Yes</button>
...
<script type="text/javascript" nonce="a6b9a780936c8e980939086f618dded2">
    function deleteFunction(ps_id){
    $('#ps_id').val(ps_id);
    $('#deleteFunction').modal('show');
    }
    $(document).ready(function(){
        
        $('.ps_id').on('click', function(){
            var id = $('#ps_id').val();
                // make ajax request
                $.ajax({
                    type: "post",
                    url: '<?php echo base_url(); ?>' + "police_station/delete",
                    data: {
                        'id' : id,
        ...
        $('.status_change').one('click', function (e) {
            ...
            $.ajax({
                type: "post",
                url: "<?php echo base_url(); ?>police_station/status_change",
                data: {
                    'id' : id,
                    'status' : status,
                    '<?php echo $this->security->get_csrf_token_name(); ?>' : '<?php echo $this->security->get_csrf_hash(); ?>'
        ...
        window.checkField = function() {
            ...
            if (x === "") { 
            var x = document.getElementById("police_station_name").value;
            }
        ...
        $('#reset_btn').click(function () { 
            ...
            window.location.href = "<?php echo base_url(); ?>police_station"           
        });
    });
</script>
