    ...
    <section id="content">
        <div class="page page-forms-validate">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="<?php echo base_url(); ?>applicants_login/change_of_gender_govt_list">Change of Gender</a></li>
                        ...
                        <div class="boxs-body"><br>
                            <div class="border_data">
                                ...
                                <div class="row">
                                    ...
                                    <?php $remarks = $this->Applicants_login_model->get_remarks_on_change_of_gender($gz_dets->id, $gz_dets->current_status); ?>
                                    <div class="form-group col-md-6">
                            ...
                            <div class="row">
                                ...
                                <?php if ($this->session->userdata('is_admin')) { ?>
                                    <div class="box-footer text-right bg-tr-black lter dvd dvd-top">
                                        ...
                                        <div class="form-group col-md-12"> 
                                            <label for="username">Per Page Price : <?php echo $pp_price = $this->Applicants_login_model->get_per_page_value_change_of_gender(); ?></label>
                                        </div>
                                        <div class="form-group col-md-12"> 
                                            <label for="username">Total : <?php echo $pp_price * $num_pag; ?></label>
                                        </div>
                                        <a href="<?php echo base_url(); ?>applicants_login/forward_to_pay_change_gender/<?php echo $this->uri->segment(3) ?>" class="btn btn-raised btn-success edit_btn">Forward To Pay</a>
                                    </div>
                                <?php } ?>
                            </div>
                        </div>
                        ...
                        <div class="boxs-body">
                            ...
                            <div class="boxs-footer text-right bg-tr-black lter dvd dvd-top">
                                <?php if ($details->current_status == 10) { ?>
                                    ...
                                    <!-- press_add_change_gender method and view file created -->
                                    <a href="<?php echo base_url(); ?>applicants_login/press_add_change_gender/<?php echo $id; ?>" class="btn btn-raised btn-success edit_btn">Press Add</a>
                                ...
                                <?php } else if ($details->current_status == 17 && empty($details->press_signed_pdf)) { ?>
                                    ...
                                    <a href="https://localhost:44303/StartPage.aspx?files=<?php echo $pdf->press_pdf; ?>&page=<?php echo $num_pag; ?>&gazette_id=<?php echo $id; ?>&type=press&category=cog&signed_name=<?php echo $signed_name; ?>&designation=<?php echo $designation; ?>" class="btn btn-raised btn-info govt_press_sign" id="govt_press_sign" >Sign PDF<div class="ripple-container"></div></a>
                                ...
                                <?php if (!empty($details->press_signed_pdf) && $details->is_published == 0) { ?>
                                    ...
                                    <a href="<?php echo base_url(); ?>applicants_login/change_gender_publish/<?php echo $details->id; ?>" class="btn btn-raised btn-success edit_btn">Publish</a>
