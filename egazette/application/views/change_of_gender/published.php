...
<section id="content">
    <div class="page page-tables-footable">
        ...
        <?php 
            ...
            if(!empty($statusType) || !empty($file_no) || !empty($notice_date_form) || !empty($notice_date_to)){
                $class= "";
            }else{
                $class= "d-none";
            }
        ...
        <div class="col-md-15">
                <section class="boxs box_report <?php echo $class ?>" id="show_filter_form">
                    ...
                    <?php echo form_open('applicants_login/published_change_of_gender_govt_list', array('method' => 'post','id'=>'search_data', 'autocomplete' => 'off')); ?>
                        <div class="boxs-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" name="file_no" id="file_no" class="form-control" autocomplete="off" placeholder = "XG-0200-2022" value="<?php echo $file_no; ?>">
                ...
                <section class="boxs">
                    <div class="boxs-header filter-with-add">
                        <?php if ($this->session->userdata('is_admin')) { ?>
                                <h3 class="custom-font hb-blue"><strong>Published Change of Gender Details</strong></h3>
                        <?php } else { ?>
                            <h3 class="custom-font hb-blue"><strong>Published Change of Gender Details</strong></h3>
                        <?php } ?>
                        <div class="">
                        ...
                        <div class="bs-example bs-example-tabs" data-example-id="togglable-tabs">
                            <div>
                                <table id="searchTextResults" data-filter="#filter" data-page-size="5" class="footable table table-custom">
                                    ...
                                    <tbody>
                                        <?php if (!empty($partner_publish)) { ?>
                                            <!-- <?php //var_dump($partner_publish);die();?> -->
                                            <?php
                                            ...
                                            <?php foreach ($partner_publish as $partner) { ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo get_nice_datetime($partner->created_at); ?></td>
                                                    <td><?php echo  $partner->status_name; ?></td>
                                                    
                                                    <td class="center">          
                                                            <a href="<?php echo base_url(); ?>applicants_login/view_details_change_gender_govt/<?php echo $partner->id; ?>"><i class="fa fa-eye"></i></a>
                                                    </td>
                                                    <td>
                                                        <a href="<?php echo $partner->notice_softcopy_pdf; ?>" target="_blank">
...
<script type="text/javascript" nonce="a6b9a780936c8e980939086f618dded2">
    $(document).ready(function(){
        ...
        $('#reset_btn').click(function () { 
            ...
            window.location.href = "<?php echo base_url(); ?>applicants_login/published_change_of_gender_govt_list"           
        });
