    ...
    <div class="page page-tables-footable">
        ...
        <div class="b-b mb-10">
            <div class="row">
                <div class="col-sm-12 col-xs-12">
                        <h1 class="h3 m-0">Change of Gender</h1>
        ...
        <div class="col-md-15">
                <section class="boxs box_report">
                    <?php echo form_open('applicants_login/search_change_of_gender_govt_list', array('method' => 'post','id'=>'search_data', 'autocomplete' => 'off')); ?>
                        <div class="boxs-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" name="file_no" id="file_no" class="form-control" autocomplete="off" placeholder = "XG-0200-2022">
                        ...
                        <div class="bs-example bs-example-tabs" data-example-id="togglable-tabs">
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade active in" role="tabpanel" id="pending" aria-labelledby="unpublished-tab">
                                 ...
                                 <div class="tab-pane fade " role="tabpanel" id="published" aria-labelledby="unpublished-tab">
                                    <table id="searchTextResults" data-filter="#filter" data-page-size="5" class="footable table table-custom">
                                        <thead>
                                            <tr>
                                                <th>Sl No</th>
