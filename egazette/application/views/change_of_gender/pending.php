    ...
    <div class="page page-tables-footable">
        ...
        <div class="col-md-15">
                <section class="boxs box_report <?php echo $class ?>" id="show_filter_form">
                    ...
                    <?php echo form_open('applicants_login/change_of_gender_govt_list', array('method' => 'post','id'=>'search_data', 'autocomplete' => 'off')); ?>
                        <div class="boxs-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" name="file_no" id="file_no" class="form-control" autocomplete="off" placeholder = "XG-0200-2024" value="<?php echo $file_no; ?>">
                ...
                <section class="boxs">
                    <div class="boxs-header filter-with-add">
                        <?php if ($this->session->userdata('is_admin')) { ?>
                                <h3 class="custom-font hb-blue"><strong>Pending Change of Gender Details</strong></h3>
                        <?php } else { ?>
                            <h3 class="custom-font hb-blue"><strong>Pending Change of Gender Details</strong></h3>
                        <?php } ?>
                        <div class="">
...
<script type="text/javascript" nonce="a6b9a780936c8e980939086f618dded2">
    $(document).ready(function(){
        ...
        $('#reset_btn').click(function () { 
            ...
            window.location.href = "<?php echo base_url(); ?>applicants_login/change_of_gender_govt_list"           
        });

        $('#search_name').click(function(){
            var x = document.getElementById("file_no").value;
            if(x === ""){
            var x = document.getElementById("statusType").value;
            }
            if(x === ""){
