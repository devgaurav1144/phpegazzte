...
<html class="no-js">
    ...
    <body class="home-body">
        ...
        <section class="inner-banner">
            <div class="container">
                <h1>Extraordinary Gazettes (Change of Name/Surname)</h1>
            </div>
        </section>
                    ...
                    <div class="col-lg-12">
                        <div class="breadcumb">
                            <ul>
                                ...
                                <li>Extraordinary Gazettes (Change of Name/Surname)</li>
                            </ul>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 media-section fadeInBottom">
                                <div class="infographic-section">
                                    <h3 class="head-section teal">Extraordinary Gazettes (Change of Name/Surname)
                                            ...
                                            <tbody>
                                                <?php if (!empty($gazette_list)) { ?>
                                                    <?php foreach ($gazette_list as $gazette) { ?>
                                                        <tr>
                                                            <td><?php echo $gazette->name . " " . $gazette->father_name; ?></td>
                                                            <td>Change of Name/Surname</td>
                                                            <td><?php echo date("Y-m-d", strtotime($gazette->modified_at)); ?></td>
                                                            <td><a href="<?php echo $gazette->press_signed_pdf; ?>" target="_blank"><span class="download"><img src="<?php echo base_url(); ?>assets/frontend/images/download.png"/></span></a></td>
                                                        </tr>
                                                    <?php } ?>
                                                <?php } else { ?>
                                                    <tr>
