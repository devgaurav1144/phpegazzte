                        ...
                        <div class="boxs-body">
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="user_name" id="user_name" class="form-control" autocomplete="off" value="<?php echo set_value('user_name'); ?>">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="mobile" id="mobile" class="form-control"  autocomplete="off" value="<?php echo set_value('mobile'); ?>" minlength="10" maxlength="10"> 
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="dob" id="dob" class="form-control"  autocomplete="off" value="<?php echo set_value('dob'); ?>">
...
$(document).ready(function () {
    ...
    $('#form1').validate({
        ...
        submitHandler: function (form) {
           ...
           $.ajax({
               type: "POST",
               url: "<?php echo base_url(); ?>gazette_hod/add_hod_officers",
