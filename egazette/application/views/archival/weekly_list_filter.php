...
<section id="content">
    <div class="page page-tables-footable">
        ...
        <ol class="breadcrumb">
            ...
            <li>Archival</li>
            <li class="active">Weekly Gazette (Archival)</li>
        </ol>
        <!-- row -->
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <section class="boxs">
                    <div class="boxs-header">
                        <h3 class="custom-font hb-blue"><strong>Weekly Gazettes</strong></h3>
                        <a href="<?php echo base_url(); ?>archival/add" class="btn-bg btn btn-success btn-right-align">Add</a>
                        <a href="<?php echo base_url(); ?>archival/weekly" class="btn-bg btn btn-success btn-right-align">All Gazettes</a>
                    </div>
                    <div class="boxs-body">
                                            ...
                                            <td>
                                                <div class="btn-group mr5 btn-grp-mr">
                                                    ...
                                                    <ul class="dropdown-menu" role="menu">
                                                        ...
                                                        <li>
                                                            <a href="<?php echo base_url(); ?>archival/weekly_view/<?php echo $gazette->id ?>">View</a>
                                                        </li>
                                                        <li>
                                                            <a href="<?php echo base_url(); ?>archival/edit_weekly_view/<?php echo $gazette->id ?>">Edit</a>
                                                        </li>
                                                        <li>
...
<script type="text/javascript" nonce="a6b9a780936c8e980939086f618dded2">
    $(document).ready(function () {
        ...
        $('#reset_btn').click(function () { 
            ...
            window.location.href = "<?php echo base_url(); ?>archival/weekly"           
        });
        ...
        $('#search_name').click(function(){
            var x = document.getElementById("week_id").value;
            if(x === ""){
