...
<!--                            <div class="row">
                                ...
                                <div class="form-group col-md-4 ext">
                                    ...
                                    <select name="dept_id" id="dept_id" class="form-control" required>
                                        ...
                                        <?php if (!empty($dept)) { ?>
                                            ...
                                            <option value="<?php echo $type->id; ?>" <?php if ($type->id == $gz_dets->department_id) { echo 'selected'; } ?>><?php echo $type->department_name; ?></option>
                                            <?php } ?>
                                        <?php } ?>
                                    </select>
                                ...
                                <div class="form-group col-md-4 ext">
                                    ...
                                    <select name="notification_type_id" id="notification_type_id" class="form-control" required>
                                        ...
                                        <?php if (!empty($notification_types)) { ?>
                                            ...
                                            <option value="<?php echo $type->id; ?>" <?php if ($type->id == $gz_dets->notification_type_id) { echo 'selected'; } ?>><?php echo $type->notification_type; ?></option>
                                            <?php } ?>
                                        <?php } ?>
                                    </select>
                            ...
                            <div class="row">
                                <div class="form-group col-md-4 ext">
                                    <label for="email">Subject : <span class="asterisk">*</span></label>
                                    <input name="subject" id="subject" class="form-control" placeholder="Enter Subject" value="<?php echo $gz_dets->subject ?>" required="" autocomplete="off">
                                    <?php if (form_error('subject')) { ?>
                                        <span class="error"><?php echo form_error('subject'); ?></span>
                                    <?php } ?>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    <label for="email">Gazette (Official Copy):
