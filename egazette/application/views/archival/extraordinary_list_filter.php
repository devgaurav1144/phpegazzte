                        ...
                        <div class="boxs-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4 ext">
                                    ...
                                    <select name="dept_id" id="dept_id" class="form-control">
                                        ...
                                        <?php if (!empty($dept)) { ?>
                                            ...
                                            <option value="<?php echo $type->id; ?>" <?php if ($type->id == $this->session->userdata('dept_id')) { echo 'selected'; } ?>><?php echo $type->department_name; ?></option>
                                            <?php } ?>
                                        <?php } ?>
                                    </select>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select name="notification_type_id" id="notification_type_id" class="form-control" >
                                        ...
                                        <?php if (!empty($notification_types)) { ?>
                                            ...
                                            <option value="<?php echo $type->id; ?>" <?php if ($type->id == $this->session->userdata('notif_type')) { echo 'selected'; } ?>><?php echo $type->notification_type; ?></option>
                                            <?php } ?>
                                        <?php } ?>
                                    </select>
                                ...
                                <div class="form-group col-md-4 ext">
                                    ...
                                    <input name="subject" id="subject" class="form-control" placeholder="Enter Subject" value="<?php echo $this->session->userdata('subject') ?>"  autocomplete="off">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input name="gazette_no" id="gazette_no" class="form-control number_only" placeholder="Enter Gazette No" value="<?php echo $this->session->userdata('gz_no'); ?>"  autocomplete="off">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input name="f_date" id="f_date" class="form-control" placeholder="DD-MM-YYYY" value="<?php echo $this->session->userdata('f_date'); ?>"  autocomplete="off">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input name="t_date" id="t_date" class="form-control" placeholder="DD-MM-YYYY" value="<?php echo $this->session->userdata('t_date'); ?>"  autocomplete="off">
            ...
            <div class="col-md-12">
                <section class="boxs">
                    <div class="boxs-header">
                        ...
                        <a href="<?php echo base_url(); ?>archival/extraordinary" class="btn-bg btn btn-success btn-right-align">All Gazettes</a>
                    </div>
                    <div class="boxs-body">
                                    ...
                                    <?php foreach ($gazettes as $gazette) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="<?php echo site_url('Archival_ControllerEW/view_gazette/' . $gazette->id); ?>"><i class="fa fa-file-pdf-o"></i></a>
                                            </td>
                                            <td>
