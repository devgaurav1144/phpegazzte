            ...
            <div class="col-md-12">
                <section class="boxs">
                    <div class="boxs-header">
                        <h3 class="custom-font hb-blue"><strong>About Us</strong></h3>
                    </div>
                    <?php echo form_open('Cms_System/about_us_content', array('name' => "form1", 'role' => "form", 'id' => "smtp_form", 'enctype' => "multipart/form-data", 'method' => "post")); ?>    
                        <div class="boxs-body">
                            <div class="row">
                                <div class="form-group col-md-12">
                                    <label for="email">Description : <span class="asterisk">*</span></label>
                                    <textarea class="form-control" name="about_desc" id="about_desc"><?php echo $aboutDetails[0]['cms_desc']; ?></textarea>
                                    <?php if (form_error('about_desc')) { ?>
                                        <span class="error"><?php echo form_error('about_desc'); ?></span>
                                    <?php } ?>
                                </div>
                            </div>
                        </div>
