...
<section id="content">
    <div class="page page-forms-validate">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">About Gazette</li>
        </ol>
        <!-- row -->
        <div class="row">
            <div class="col-md-12">
                <section class="boxs">
                    <div class="boxs-header">
                        <h3 class="custom-font hb-blue"><strong>About Gazette</strong></h3>
                    </div>
                    <?php echo form_open('Cms_System/about_gazette', array('name' => 'form1', 'role' => 'form', 'id' => 'smtp_form', 'enctype' => 'multipart/form-data', 'method' => 'post')); ?>
                        <div class="boxs-body">
                            <div class="row">
                                <div class="form-group col-md-12">
                                    <label for="email">Description : <span class="asterisk">*</span></label>
                                    <textarea class="form-control" name="gazette_desc" id="gazette_desc"><?php if($gazetteDetails[0]['cms_desc']){echo $gazetteDetails[0]['cms_desc'];}?></textarea>
                                    <?php if (form_error('gazette_desc')) { ?>
                                        <span class="error"><?php echo form_error('gazette_desc'); ?></span>
                                    <?php } ?>
                                </div>
                            </div>
                        </div>
