        ...
        <div class="b-b mb-10">
            <div class="row">
                <div class="col-sm-6 col-xs-12">
                    <h1 class="h3 m-0">Urban Local Body</h1>
...
<section id="content">
    <div class="page page-tables-footable">
        ...
        <?php
            ...
            if(isset($inputs['ulb_name'])){
                $ulb_name = $inputs['ulb_name'];
            }

            if(!empty($state_name) || !empty($district_name) || !empty($ulb_name)){
                $class= "";
            }else{
                $class= "d-none";
            }
        ...
        <div class="">
            <div class="col-md-15">
                <section class="boxs box_report <?php echo $class?>" id="show_filter_form">
                    ...
                    <?php echo form_open('ulb/search_ulb', array('method' => 'post','id' => "formsearch",'name' => "formsearch")); ?>
                    <div class="boxs-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                <label for="psname">ULB Name :</label>
                                <input type="text" name="ulb_name" id="ulb_name" class="form-control" autocomplete="off" value="<?php echo set_value('ulb_name'); ?>">
            ...
            <div class="col-md-12">
                <section class="boxs">
                    <div class="boxs-header filter-with-addd">
                        <h3 class="custom-font hb-blue"><strong>ULB</strong></h3>
                        ...
                        <a href="<?php echo base_url(); ?>ulb/add" class="btn-bg btn btn-success btn-right-align">Add</a>
                    </div>
                    <div class="boxs-body">
                            ...
                            <tbody>
                                <?php if (!empty($ulbs)) { ?>
                                    ...
                                    <?php foreach ($ulbs as $ulb) { ?>
                                        <tr>
                                            <td><?php echo $cntr; ?></td>
                                            <td><?php echo $ulb->ulb_name;?></td>
                                            <td><?php echo $ulb->district_name;?></td>
                                            <td><?php echo $ulb->state_name;?></td>
                                            <td>
                                                <div class="status_change togglebutton" id="<?php echo $ulb->id; ?>" title="<?php echo $ulb->status; ?>">
                                                    <label><input type="checkbox" <?php echo ($ulb->status == 1) ? "checked" : ""; ?>></label>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="btn-group mr5 btn-grp-mr">
                                                    ...
                                                    <ul class="dropdown-menu" role="menu">
                                                        <li><a href="<?php echo base_url();?>ulb/edit/<?php echo $ulb->id; ?>">Edit</a></li>
                                                        <li class="delete_id" id="<?php echo $ulb->id; ?>"><a href="javascript:void(0);" onclick="deleteFunction(<?php echo $ulb->id; ?>)">Delete<div class="ripple-container"></div></a></li>
                                                    </ul>
                                                </div>
                                            </td>
                                        </tr>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-primary ulb_id">Yes</button>
...
<script type="text/javascript" nonce="a6b9a780936c8e980939086f618dded2">
        function deleteFunction(ulb_id){
        $('#ulb_id').val(ulb_id);
    ...
    $(document).ready(function(){
        ...
        $('.ulb_id').on('click', function(){
            var id = $('#ulb_id').val();
                // make ajax request
                $.ajax({
                    type: "post",
                    url: '<?php echo base_url(); ?>' + "ulb/delete",
                    data: {
                        'id' : id,
        ...
        $('.status_change').one('click', function (e) {
            ...
            $.ajax({
                type: "post",
                url: "<?php echo base_url(); ?>ulb/status_change",
                data: {
                    'id' : id,
                    'status' : status,
                    '<?php echo $this->security->get_csrf_token_name(); ?>' : '<?php echo $this->security->get_csrf_hash(); ?>'
        ...
        window.checkField = function() {
            ...
            if(x === ""){
                var x = document.getElementById("ulb_name").value;
            }
        ...
        $('#reset_btn').click(function () { 
            ...
            window.location.href = "<?php echo base_url(); ?>ulb"           
        });
    });
</script>
