...
<html class="no-js" lang="">
    <head>
        ...
        <style nonce="8f0882ce3be14f201cadd0eff5726cbd">
            ...
            .login_bg {
                background-image: url('<?php echo base_url(); ?>assets/images/login-bg.svg'); background-size: cover; background-position: top center;
            }
            .form-group {
                    ...
                    <div class="row">
                        <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
                            <div class="card card-signup">
                                <?php echo form_open('user/login', array('id' => 'login_form', 'method' => 'post', 'class' => 'form')); ?>
                                    <div class="header header-primary text-center">
                                        <a href="<?php echo base_url(); ?>"><img width="270px;" src="<?php echo base_url(); ?>assets/frontend/images/uplogo.png"/></a>
                                    </div>
                                    <h3 class="mt-0 text-center">Sign In</h3>
                                    <div class="middle">
                                    ...
                                    <div class="content">
                                        <div class="form-group mobile_number">
                                            ...
                                            <input type="text" name="mobile" id="mobile" class="form-control underline-input" placeholder="Enter Login ID" required autocomplete="off" value="" maxlength="15">
                                        ...
                                        <label class="field-head">Password <span class="mandatory">*</span></label>
                                            ...
                                            <?php } ?>
                                            <a href="<?php echo base_url(); ?>user/forgot_password" class="btn btn-wd forgot-p">Forgot Password?</a>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="text-center text-muted content-divider mb-3">
                                            ...
                                            <a href="<?php echo base_url(); ?>user/register" class="btn btn-default btn-raised w-100">Register</a>
                                            <?php echo form_close(); ?>
            ...
            $("#login_form").validate({
                ...
                messages: {
                    mobile: {
                       ...
                       minlength: 'Login ID should be minimum 5 characters',
                       maxlength: 'Login ID should be maximum 15 characters'
                    },
                    password: {
