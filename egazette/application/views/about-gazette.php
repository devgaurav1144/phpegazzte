...
<html class="no-js">
    <head>
        ...
        <title>About Gazette | eGazette | Government of (StateName)</title>
        <meta charset="UTF-8">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 fadeInScale">
                        <div class="infographic-section media-section">
                            <!-- <h3 class="head-section pink">About Gazette</h3> -->
                            <!-- <div class="content-part">
                                <div class="row">
                                    <div class=""> -->
                                        <div class="about-us-content">
                                            <?php $pattern = '#<(.+?)style=(:?"|\')?[^"\']+(:?"|\')?(.*?)>#si'; ?>
                                            <?php echo preg_replace($pattern, '<\\1>', $gazetteDetails[0]['cms_desc']); ?>
                                        </div>
                                    <!-- </div>
                                </div>
                            </div> -->
