...
<html class="no-js">
    ...
    <body class="home-body">
        ...
        <section class="inner-banner">
            <div class="container">
                <h1>Extraordinary Gazettes (Land Acquisition)</h1>
            </div>
        </section>
                    ...
                    <div class="col-lg-12">
                        <div class="breadcumb">
                            <ul>
                                ...
                                <li>Extraordinary Gazettes (Land Acquisition)</li>
                            </ul>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 media-section fadeInBottom">
                                <div class="infographic-section">
                                    <h3 class="head-section teal">Extraordinary Gazettes (Land Acquisition)
