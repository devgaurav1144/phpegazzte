...
<section id="content">
    <div class="page page-tables-footable">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Published Change Name/Surname</li>
        </ol>

        <div class="b-b mb-10">
            <div class="row">
                <div class="col-sm-6 col-xs-12">
                    <h1 class="h3 m-0">Change of Name/Surname - Published Gazettes</h1>
        ...
        <div class="col-md-15">
                <section class="boxs box_report">
                    <?php echo form_open('published/filter_for_change_name_surname', array('method' => 'post','id'=>'search_data', 'autocomplete' => 'off')); ?>
                        <div class="boxs-body">
                            <div class="row">
