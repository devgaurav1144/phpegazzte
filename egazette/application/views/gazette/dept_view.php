                ...
                <section class="boxs">
                    ...
                    <div class="boxs-body">
                        ...
                        <div class="row">
                            ...
                            <?php echo form_open('gazette/resubmit_save_gazette', array('class' => "form1", 'name' => "form1", 'id' => "resubmit_ex_dept_gazette", 'method' => "post", 'enctype' => "multipart/form-data")); ?>    
...
<script type="text/javascript" nonce="a6b9a780936c8e980939086f618dded2">
    $(document).ready(function(){
        ...
        $("#resubmit_ex_dept_gazette").validate({
            rules: {
                doc_files: {
                    required: true,
                    extension: "docx",
