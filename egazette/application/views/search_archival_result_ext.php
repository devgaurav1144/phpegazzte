                                ...
                                <div class="row">
                                    <?php echo form_open('extraordinary_archival_search', array('method' => 'post', 'class' => 'row', 'id' => 'filter', 'name' => 'filter')); ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="dept_id" id="dept_id" class="form-control" >
                                                        ...
                                                        <?php if (!empty($dept)) { ?>
                                                            ...
                                                            <option value="<?php echo $type->id; ?>" <?php if ($this->session->userdata('dept_id') == $type->id) { echo 'selected'; } ?>><?php echo $type->department_name; ?></option>
                                                            <?php } ?>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="notification_type_id" id="notification_type_id" class="form-control" >
                                                        ...
                                                        <?php if (!empty($notification_type)) { ?>
                                                            ...
                                                            <option value="<?php echo $type->id; ?>" <?php if ($this->session->userdata('notif_type') == $type->id) { echo 'selected'; } ?>><?php echo $type->notification_type; ?></option>
                                                            <?php } ?>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 marg">
                                            <div class="search-gazette">
                                                <div class="form-group">
                                                    ...
                                                    <input name="t_date" id="t_date" class="form-control " placeholder="YYYY-MM-DD" value="<?php $this->session->userdata('t_date'); ?>"  autocomplete="off">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 marg">
                                        ...
                                        <div class="submit-button">
                                            ...
                                            <button class="hvr-shutter-out-horizontal middle-btm" id="reset">Reset</button>
                                        </div>
                                    <?php echo form_close(); ?>
                                </div>
                            </div>
...
<script type="text/javascript" nonce="a6b9a780936c8e980939086f618dded2">
    ...
    $(document).ready(function () {
        ...
        $('#reset').click(function () { 
            ...
            $.ajax({
                type: "POST",
                url: '<?php echo base_url(); ?>' + "website/session_clear",
                complete: function () {
