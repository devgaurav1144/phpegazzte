            ...
            <div class="col-md-12">
                <section class="boxs">
                    <div class="boxs-body">
                        ...
                        <!-- 
                            -   I left from filter_change_gender.php view page
                            -   This page work is complete
                            -   continue with other flow...
                            -   check the applicant dashboard for gender......
                        -->
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input 
                                        ...
                                        id="file_no" 
                                        name="file_no" 
                                        placeholder="XG-0000-<?php echo date('Y'); ?>" 
                                        class="form-control" 
                                        maxlength="12" 
                                        autocomplete="off" 
                                        value="<?php echo $this->session->userdata('file_no') ?>"
                                    />
                ...
                <section class="boxs">
                    <div class="boxs-body">
                        <a href="<?php echo base_url(); ?>check_status/change_gender_status" class="btn-bg btn btn-success btn-right-align">All Gazettes</a>
