...
<section id="content">
    <div class="page page-tables-footable">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Change of Name/Surname Status details</li>
                        ...
                        <?php echo form_open('check_status/filter_change_name', array('id' => 'filter_form', 'name' => 'filter_form', 'method' => 'POST')) ?>
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" id="file_no" name="file_no" placeholder="XN-0000-<?php echo date('Y'); ?>" class="form-control" maxlength="12" autocomplete="off" value=""/>
