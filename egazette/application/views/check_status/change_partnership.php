...
<section id="content">
    <div class="page page-tables-footable">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Change of Partnership Status details</li>
        ...
        <div class="b-b mb-10">
            <div class="row">
                <div class="col-sm-6 col-xs-12">
                    <h1 class="h3 m-0">Change of Partnership - Check Status</h1>
            ...
            <div class="col-md-12">
                <section class="boxs">
                    <div class="boxs-body">
                        ...
                        <?php echo form_open('check_status/filter_change_partnership', array('id' => 'filter_form', 'name' => 'filter_form', 'method' => 'POST')) ?>
                            
                            <div class="row">
                                <div class="form-group col-md-3">
                                    <label for="file_no">File Number : </label>
                                    <input type="text" id="file_no" name="file_no" placeholder="XP-0000-<?php echo date('Y'); ?>" class="form-control" maxlength="12" autocomplete="off" value=""/>
                                    
                                </div>
                                <div class="form-group col-md-3">
                                    <label for="f_date">From Date : </label>
                                    <input type="text" id="f_date" name="f_date" placeholder="DD-MM-YYYY" class="form-control" autocomplete="off"/>
                                    
                                </div>
                                <div class="form-group col-md-3">
                                    <label for="t_date">To Date : </label>
                                    <input type="text" id="t_date" name="t_date" placeholder="DD-MM-YYYY" class="form-control" autocomplete="off"/>
                                    ...
                                    <select name="status_id" id="status_id" class="form-control">
                                        ...
                                        <?php if (!empty($status)) { ?>
                                            <?php foreach ($status as $state) { ?>
                                                <option value="<?php echo $state->id; ?>"><?php echo $state->status_det; ?></option>
                                            <?php } ?>
                                        <?php } ?>
                                    </select>
                            ...
                            <div class="row">
                                <div class="col-md-5">
                                    <button type="submit" id= "search_name" class="btn-bg btn btn-success">Search</button>
                                    <span id="error"></span>
                                </div>
                            </div>
                            ...
                            <tbody>
                                <?php if (!empty($change_of_names)) { ?>
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            <td><?php echo $cntr; ?></td>
                                            <td><?php echo $data->gazette_type; ?></td>
                                            <td><?php echo $data->file_no; ?></td>
                                            <td><?php echo  strftime('%d %b %Y, %I:%M %p', strtotime($data->created_at)); ?></td>
                                            <td><?php echo $data->status_det; ?></td>
                                            <td>
                                                <a href="<?php echo base_url(); ?>check_status/change_partnership_status_details/<?php echo $data->id; ?>"><i class="fa fa-eye"></i></a>
                                            </td>
                                        </tr>
                                        <?php $cntr++;
                                    } ?>
...
<script type="text/javascript" nonce="a6b9a780936c8e980939086f618dded2">
    $(document).ready(function(){
        ...
        $('#search_name').click(function(){
            ...
            var f_data = document.getElementById("f_date").value;
            var t_data = document.getElementById("t_date").value;
            var status_data = document.getElementById("status_id").value;
            const error = document.getElementById('error');
            if (data === "" && f_data === "" && t_data === "" && status_data === "") { 
