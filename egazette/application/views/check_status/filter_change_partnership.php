    ...
    <div class="page page-tables-footable">
        ...
        <div class="row">
            <div class="col-md-12">
                        ...
                        <?php echo form_open('check_status/filter_change_partnership', array('id' => 'filter_form', 'name' => 'filter_form', 'method' => 'POST')) ?>
                            ...
                            <div class="row">
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" id="file_no" name="file_no" placeholder="XP-0000-<?php echo date('Y'); ?>" class="form-control" maxlength="12" autocomplete="off" value="<?php echo $this->session->userdata('file_no') ?>"/>
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <select name="status_id" id="status_id" class="form-control">
                                        ...
                                        <option value="<?php echo $state->id; ?>" <?php if ($this->session->userdata('status_id') == $state->id) { echo 'selected'; } ?>><?php echo $state->status_det; ?></option>
                                            <?php } ?>
                                        <?php } ?>
                                    </select>
                ...
                <section class="boxs">
                    <div class="boxs-body">
                        <a href="<?php echo base_url(); ?>check_status/change_partnership_status" class="btn-bg btn btn-success btn-right-align">All Gazettes</a>
