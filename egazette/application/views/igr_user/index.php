            ...
            <div class="col-md-12">
                <section class="boxs">
                    <div class="boxs-header">
                        <h3 class="custom-font hb-blue"><strong>IGR Users</strong></h3>
                        <a href="<?php echo base_url(); ?>igr_user/igr_user_registration" class="btn-bg btn btn-success btn-right-align">Add</a>
                    </div>
                    <div class="boxs-body">
                                ...
                                <?php if (!empty($users)) { ?>
                                    ...
                                    <?php foreach ($users as $user) { ?>
                                        <tr>
                                            ...
                                            <td><?php echo $user->verify_approve; ?></td>
                                            <td>
                                                <div class="stat_change togglebutton" id="<?php echo $user->id; ?>" title="<?php echo $user->status; ?>">
                                                    <label><input type="checkbox" <?php echo ($user->status == 1) ? "checked" : ""; ?>></label>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="btn-group mr5 btn-grp-mr">
                                                    ...
                                                    <ul class="dropdown-menu" role="menu">
                                                        ...
                                                        <li><a href="<?php echo base_url(); ?>igr_user/igr_user_edit/<?php echo $user->id; ?>">Edit</a></li>
    ...
    $(document).ready(function () {
        $('.delete_id').on('click', function(){
            ...
            if (confirm('Are you sure to delete the user')) {
                ...
                $.ajax({
                    type: "post",
                    url: '<?php echo base_url(); ?>' + "igr_user/delete",
                    data: {
        ...
        $('.stat_change').one('click', function (e) {
            ...
            $.ajax({
                type: "post",
                url: "<?php echo base_url(); ?>igr_user/status_change",
                data: {
                    'user_id' : user_id,
                    'status' : status,
