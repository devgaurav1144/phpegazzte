...
<section id="content">
    <div class="page page-forms-validate">
        <ol class="breadcrumb">
            ...
            <li class="active">Add IGR User</li>
        </ol>
        <!-- bradcome -->
            ...
            <div class="col-md-12">
                <section class="boxs">
                    <div class="boxs-header">
                        <h3 class="custom-font hb-blue"><strong>Add IGR User</strong></h3>
                    </div>
                        ...
                        <div class="boxs-body">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="user_name" id="user_name" class="form-control alpha_only" autocomplete="off" value="<?php echo set_value('user_name'); ?>">
...
$(document).ready(function () {
    ...
    jQuery.validator.addMethod("mobile", function (value, element) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>igr_user/check_unique_mobile",
            data: {
                'mobile': mob,
                '<?php echo $this->security->get_csrf_token_name(); ?>' : '<?php echo $this->security->get_csrf_hash(); ?>'
            },
            success: function(response){
                res = ( response == 'true' ) ? true : false;
            }
        });
        return res;
    });
    ...
    jQuery.validator.addMethod("email_unique", function (value, element) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>igr_user/check_unique_email",
            data: {
                'email': email,
                '<?php echo $this->security->get_csrf_token_name(); ?>' : '<?php echo $this->security->get_csrf_hash(); ?>'
            },
            success: function(response){
                res1 = ( response == 'true' ) ? true : false;
            }
        });
        return res1;
    });
    ...
    $('#add_user').validate({
        ...
        submitHandler: function (form) {
           ...
           $.ajax({
               type: "POST",
               url: "<?php echo base_url(); ?>igr_user/add_igr_user",
