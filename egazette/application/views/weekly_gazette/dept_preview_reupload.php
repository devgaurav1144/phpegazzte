                ...
                <section class="boxs">
                    ...
                    <div class="boxs-body">
                        ...
                        <div class="row">
                            ...
                            <?php echo form_open('weekly_gazette/reupload_save_gazette', array('class' => "form1", 'name' => "form1", 'id' => 'wk_reupload_gazette', 'method' => "post", 'enctype' => "multipart/form-data")); ?>
                                ...
                                <div class="boxs-body">
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <span class="help-block mb-0 upload_help">Maximum 5 MB allowed.</span>
