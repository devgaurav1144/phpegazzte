...
<section id="content">
    <div class="page page-forms-validate">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Preview Final Weekly Gazette</li>
        </ol>
            ...
            <div class="col-md-12">
                <section class="boxs">
                    <div class="boxs-header">
                        <h3 class="custom-font hb-blue"><strong>Preview Final Weekly Gazette</strong></h3>
                    </div>
                    <?php echo form_open('weekly_gazette/press_pdf_view', array('role' => "form", 'method' => "post", 'id' => "gazette_form")); ?>    
                        ...
                        <div class="gazette-main" id="gazette_main_container">
                            ...
                            <div class="content-container">
                                <?php foreach ($dept_data_list as $list) { ?>
                                    <span class="part_name"><?php echo $list->part_name; ?></span>
                                    <span class="section_name"><?php echo $list->section_name; ?></span>
                                    <div class="content-data-view"><?php echo $list->content; ?></div>
                                <?php } ?>
                            </div>
                            <footer>
                                <div class="line"></div>
                                <p>Processed and e-Published by the Directorate of Printing, Stationery and Publication, (StateName), Cuttack-10</p><p>
                                </p>
                            </footer>
                        </div>
                        <div class="boxs-footer text-right bg-tr-black lter dvd dvd-top">
                            <button type="submit" class="btn btn-raised btn-success" id="form4Submit">Save</button>
                        </div>
                    <?php echo form_close(); ?>
                </section>
            </div>
