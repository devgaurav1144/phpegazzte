...
<section id="content">
    <div class="page page-tables-footable">
        ...
        <section class="boxs box_report d-none" id="show_filter_form">
            ...
            <div class="boxs-body">
                <?php echo form_open('weekly_gazette/merged_wk_gz', array('method' => 'post', 'id'=>'search_data', 'autocomplete' => 'off')); ?>
                <div class="row">
                    <div class="col-md-3">
        ...
        <section class="boxs">
            <div class="boxs-header filter-with-add">
                <?php if ($this->session->userdata('is_admin')) { ?>
                        <h3 class="custom-font hb-blue"><strong>Gotv. Press Merged Weekly Gazette</strong></h3>
                <?php } else { ?>
