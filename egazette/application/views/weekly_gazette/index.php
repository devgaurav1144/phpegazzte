...
<section id="content">
    <div class="page page-tables-footable">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Pending Weekly Gazette</li>
        </ol>
        ...
        <section class="boxs box_report <?php echo $class ?>" id="show_filter_form">
            ...
            <div class="boxs-body">
                <?php echo form_open('weekly_gazette/index', array('method' => 'post', 'id'=>'search_data', 'autocomplete' => 'off')); ?>
                <div class="row">
        ...
        <section class="boxs">
            <div class="boxs-header filter-with-add">
                <?php if ($this->session->userdata('is_admin')) { ?>
                        <h3 class="custom-font hb-blue"><strong>Pending Weekly Gazette</strong></h3>
                <?php } else { ?>
                    <h3 class="custom-font hb-blue"><strong>Pending Weekly Gazette</strong></h3>
                <?php } ?>
                <div class="">
            ...
            <div class="boxs-body">
                ...
                <div class="bs-example bs-example-tabs" data-example-id="togglable-tabs">
                    <div class="tab-content" id="myTabContent">
                                    ...
                                    <?php if (!empty($gazettes_unpublished)) { ?>
                                        ...
                                        <?php foreach ($gazettes_unpublished as $gazette) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if (!empty($gazette->dept_signed_pdf_path)) { ?>
                        ...
                        <!-- Merged -->
                        <div class="tab-pane fade" role="tabpanel" id="merged" aria-labelledby="merged-tab">
                            <table id="searchTextResults" data-filter="#filter" data-page-size="5" class="footable table table-custom">
                                <thead>
                                    <tr>
                                        <th>Sl No</th>
                                ...
                                <tbody>
                                    <?php if (!empty($gazettes_merged)) { ?>
                                        ...
                                        ?>
                                        <?php foreach ($gazettes_merged as $gazette) { ?>
                                            <tr>
                                                <td><?php echo $cntr; ?></td>
                                                <td><?php echo $gazette->part_name; ?></td>
                                                <td><?php echo $gazette->week; ?></td>
                                                <td><?php echo $gazette->year; ?></td>
                                                <td><?php echo $gazette->sl_no; ?></td>
                                                <td><?php echo $gazette->issue_date; ?></td>
                                                <td>
                                                    <a href="<?php echo base_url() . $gazette->pdf_file_path; ?>" target="_blank">
                                                        <i class="fa fa-file-pdf-o"></i>
                                                    </a>
                                                </td>
                                                <td class="center">
                                                    <?php if ($this->session->userdata('is_admin')) { ?>
                                                        <a href="<?php echo base_url(); ?>weekly_gazette/press_merge_view/<?php echo $gazette->id; ?>"><i class="fa fa-eye"></i></a>
                                                    <?php } ?>
                                                </td>
                                            </tr>
                                            <?php
...
<!-- <link rel='stylesheet' href='<?php //echo base_url(); ?>assets/js/vendor/yearpicker/Year-Picker-Text-Input/dist/yearpicker.css' nonce="8f0882ce3be14f201cadd0eff5726cbd"> -->
<!-- <script type="text/javascript" src="<?php //echo base_url(); ?>assets/js/vendor/yearpicker/Year-Picker-Text-Input/dist/yearpicker.js" nonce="a6b9a780936c8e980939086f618dded2"></script> -->
...
<script type="text/javascript" nonce="a6b9a780936c8e980939086f618dded2">
    ...
    minViewMode: "years"
            ...
            $('#reset_btn').click(function () { 
                ...
                window.location.href = "<?php echo base_url(); ?>weekly_gazette"           
            });
        });
