            ...
            <div class="col-md-12">
                <section class="boxs">
                    <div class="boxs-header">
                        <h3 class="custom-font hb-blue"><strong>Feedback</strong></h3>
                    </div>
                    <div class="boxs-body">
                            ...
                            <tbody>
                                <?php if (!empty($feedbacks)) { ?>
                                    ...
                                    <?php foreach ($feedbacks as $feedback) { ?>
                                        <tr>
                                            <td><?php echo $cntr; ?></td>
                                            <td><?php echo get_formatted_datetime($feedback->created_at); ?></td>
                                            <td><?php echo $feedback->name; ?></td>
                                            <td><?php echo $feedback->subject; ?></td>
                                            <td><a href="<?php echo base_url(); ?>feedback/view/<?php echo $feedback->id; ?>"><i class="fa fa-eye"></i></a></td>
                                        </tr>
                                    <?php $cntr++; } ?>
                                <?php } else { ?>
                                    <tr>
