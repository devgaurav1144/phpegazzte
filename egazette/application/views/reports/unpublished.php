        ...
        <div class="b-b mb-10">
            <div class="row">
                <div class="col-sm-12 col-xs-12">
                    <h1 class="h3 m-0">Unpublished Gazette Reports</h1>
                ...
                <section class="boxs">
                    ...
                    <div class="boxs-body">
                        <div class="form-group">
                            <label for="filter" class="label_txt">Search:</label>
                                ...
                                <?php if (!empty($gazettes)) { ?>
                                    ...
                                    <?php foreach ($gazettes as $gazette) { ?>
                                        <tr>
                                            ...
                                            <td><a href="<?php echo base_url() . $gazette->dept_pdf_file_path; ?>">
                                                    <i class="fa fa-file-pdf-o"></i>
                                                </a>
                                            </td>
                                            <td>
                                                <?php if ($gazette->status_id == 5) { ?>
                                                    <a href="<?php echo base_url() . $gazette->press_pdf_file_path; ?>">
                                                        <i class="fa fa-file-pdf-o"></i>
                                                    </a>
                                                <?php } ?>
                                            </td>
