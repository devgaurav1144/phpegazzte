                        ...
                        <div class="col-md-8 col-md-offset-2 col-sm-12 col-sm-offset-6 text-center">
                            <div class="card card-signup">
                                <div class="header header-primary text-center">
                                    <h4>We are unable to process as we are getting some issues with eSign.</h4>
                                </div>
                                <div class="content">
                                    <div class="row">
                                        <div class="col-md-12 text-center">
                                            <h4 class="mb-0 mt-40">Something went wrong</h4>
                                            <p class="text-muted"><?php echo $msg; ?></p>
                                        </div>
                                    </div>
                                    <!-- /input-group -->
                                    <div class="footer text-center mb-20"><a href="<?php echo base_url(); ?>dashboard" class="btn btn-info btn-raised">Return</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
