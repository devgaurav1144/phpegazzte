...
<html   class="no-js">
    <head>
        ...
        <title>About Us | eGazette | Government of (StateName)</title>
        <meta charset="UTF-8">
                ...
                <div class="row">                    
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 fadeInScale">
                        <div class="infographic-section media-section">
                            <!-- <h3 class="head-section pink">About Us</h3> -->
                            <!-- <div class="content-part">
                                <div class="row">
                                    <div class=""> -->
                                        <div class="about-us-content" id="hoverable_text">
                                            <?php $pattern = '#<(.+?)style=(:?"|\')?[^"\']+(:?"|\')?(.*?)>#si'; ?>
                                            <?php echo preg_replace($pattern, '<\\1>', $aboutDetails[0]['cms_desc']); ?>
                                        </div>
                                    <!-- </div>
                                </div>
                            </div> -->
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 left-side-bar">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 media-section fadeInBottom mt-4">
