...
// Captcha codes
// ---------------------------------------------------------------------------
$BDC_CaptchaConfig->CodeLength = CaptchaRandomization::GetRandomCodeLength(5, 5);
...
$BDC_CaptchaConfig->ImageWidth = 280;
$BDC_CaptchaConfig->ImageHeight = 80;
...
$BDC_CaptchaConfig->SoundPackagesFolder = BDC_INCLUDE_PATH . 'Resources/Sounds';
...
$BDC_CaptchaConfig->HelpLinkEnabled = null;
