        ...
        e = function() {
                ...
                render: function(a, b, d) {
                    ...
                    return this.format.replace(this.fre, function() {
                        var a;
                        return f = arguments[1], g = arguments[3], e = j.precre.exec(f), e ? (i = e[2], f = e[1]) : i = !1, h = k[f], h === c ? "" : g && b && b[g] ? (a = b[g], a.get ? b[g].get(h) || h : b[g][h] || h) : (m(h) && (h = d.get("numberFormatter") ? d.get("numberFormatter")(h) : q(h, i, d.get("numberDigitGroupCount"), d.get("numberDigitGroupSep"), d.get("numberDecimalMark"))), h)
                    })
                }
                ...
                var g, h;
                for (a = (!1 === b ? parseFloat(a).toString() : a.toFixed(b)).split(""), (g = (g = d.inArray(".", a)) < 0 ? a.length : g) < a.length && (a[g] = f), h = g - c; h > 0; h -= c) a.splice(h, 0, e);
                return a.join("")
            }, n = function(a, b, c) {
                var d;
                for (d = b.length; d--;)
            ...
            function(a) {
                ...
                if (!1 === d.fn.sparkline.canvas) return !1;
                ...
                mouseenter: function(b) {
                    d(a.body).unbind("mousemove.jqs"), d(a.body).bind("mousemove.jqs", d.proxy(this.mousemove, this)), this.over = !0, this.currentPageX = b.pageX, this.currentPageY = b.pageY, this.currentEl = b.target, !this.tooltip && this.displayTooltips && (this.tooltip = new t(this.options), this.tooltip.updatePosition(b.pageX, b.pageY)), this.updateDisplay()
                },
                mouseleave: function() {
                    ...
                    var b, c, e = this.splist,
                        f = e.length,
                        g = !1;
                    for (this.over = !1, this.currentEl = null, this.tooltip && (this.tooltip.remove(), this.tooltip = null), c = 0; c < f; c++) b = e[c], b.clearRegionHighlight() && (g = !0);
                ...
                updateDisplay: function() {
                    ...
                    if (this.over) {
                        for (c = 0; c < h; c++) b = g[c], (e = b.setRegionHighlight(this.currentEl, k, l)) && (i = !0);
                        if (i) {
                            if (f = d.Event("sparklineRegionChange"), f.sparklines = this.splist, this.$el.trigger(f), this.tooltip) {
                                for (a = "", c = 0; c < h; c++) b = g[c], a += b.getCurrentRegionTooltip();
                ...
                o(C)
            }, d(D), I = [], d.fn.sparkline = function(b, e) {
                return this.each(function() {
                    var f, g, h = new d.fn.sparkline.options(this, e),
                        i = d(this);
                    if (f = function() {
                            var e, f, g, j, k, l, m;
                            if ("html" === b || b === c ? (m = this.getAttribute(h.get("tagValuesAttribute")), m !== c && null !== m || (m = i.html()), e = m.replace(/(^\s*<!--)|(-->\s*$)|\s+/g, "").split(",")) : e = b, f = "auto" === h.get("width") ? e.length * h.get("defaultfalconsPerValue") : h.get("width"), "auto" === h.get("height") ? h.get("composite") && d.data(this, "_jqs_vcanvas") || (j = a.createElement("span"), j.innerHTML = "a", i.html(j), g = d(j).innerHeight() || d(j).height(), d(j).remove(), j = null) : g = h.get("height"), h.get("disableInteraction") ? k = !1 : (k = d.data(this, "_jqs_mhandler"), k ? h.get("composite") || k.reset() : (k = new s(this, h), d.data(this, "_jqs_mhandler", k))), h.get("composite") && !d.data(this, "_jqs_vcanvas")) return void(d.data(this, "_jqs_errnotify") || (alert("Attempted to attach a composite sparkline to an element with no existing sparkline"), d.data(this, "_jqs_errnotify", !0)));
                            l = new(d.fn.sparkline[h.get("type")])(this, e, h, f, g), l.render(), k && k.registerSparkline(l)
                        ...
                        if (!h.get("composite") && d.data(this, "_jqs_pending"))
                            for (g = I.length; g; g--) I[g - 1][0] == this && I.splice(g - 1, 1);
                        I.push([this, f]), d.data(this, "_jqs_pending", !0)
                    } else f.call(this)
                })
            }, d.fn.sparkline.defaults = e(), d.sparkline_display_visible = function() {
                var a, b, c, e = [];
                for (b = 0, c = I.length; b < c; b++) a = I[b][0], d(a).is(":visible") && !d(a).parents().is(":hidden") ? (I[b][1].call(a), d.data(I[b][0], "_jqs_pending", !1), e.push(b)) : !d(a).closest("html").length && !d.data(a, "_jqs_pending") && (d.data(I[b][0], "_jqs_pending", !1), e.push(b));
                for (b = e.length; b; b--) I.splice(e[b - 1], 1)
            }, d.fn.sparkline.options = f({
                init: function(a, b) {
                    var c, e, f, g;
                    this.userOptions = b = b || {}, this.tag = a, this.tagValCache = {}, e = d.fn.sparkline.defaults, f = e.common, this.tagOptionsPrefix = b.enableTagOptions && (b.tagOptionsPrefix || f.tagOptionsPrefix), g = this.getTagSetting("type"), c = g === J ? e[b.type || f.type] : e[g], this.mergedOptions = d.extend({}, f, c, b)
                },
                getTagSetting: function(a) {
                    ...
                    if (this.tagValCache.hasOwnProperty(a)) b = this.tagValCache.key;
                        ...
                        if ((b = this.tag.getAttribute(g + a)) === c || null === b) b = J;
                ...
                get: function(a, b) {
                    ...
                    return e !== J ? e : (d = this.mergedOptions[a]) === c ? b : d
                }
                ...
                initTarget: function() {
                    ...
                    (this.target = this.$el.simpledraw(this.width, this.height, this.options.get("composite"), a)) ? (this.canvasWidth = this.target.falconWidth, this.canvasHeight = this.target.falconHeight) : this.disabled = !0
                },
                render: function() {
                ...
                setRegionHighlight: function(a, b, d) {
                    ...
                    return b > this.canvasWidth || d > this.canvasHeight || b < 0 || d < 0 ? null : (e = this.getRegion(a, b, d), f !== e && (f !== c && g && this.removeHighlight(), this.currentRegion = e, e !== c && g && this.renderHighlight(), !0))
                },
                clearRegionHighlight: function() {
                    return this.currentRegion !== c && (this.removeHighlight(), this.currentRegion = c, !0)
                },
                ...
                getCurrentRegionTooltip: function() {
                    ...
                    for (e = b.length, p = a.length, i = 0; i < e; i++)
                        for (o = b[i], "string" == typeof o && (o = new g(o)), f = o.fclass || "jqsfield", q = 0; q < p; q++) a[q].isNull && r.get("tooltipSkipNull") || (d.extend(a[q], {
                ...
                calcHighlightColor: function(a, c) {
                    ...
                    if (j && (d = /^#([0-9a-f])([0-9a-f])([0-9a-f])$/i.exec(a) || /^#([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})$/i.exec(a))) {
                        for (f = [], e = 4 === a.length ? 16 : 1, g = 0; g < 3; g++) f[g] = h(b.round(parseInt(d[g + 1], 16) * e * j), 0, 255);
                        return "rgb(" + f.join(",") + ")"
                    }
                    return a
                }
            ...
            }, d.fn.sparkline.line = v = f(d.fn.sparkline._base, {
                type: "line",
                init: function(a, b, c, d, e) {
                    v._super.init.call(this, a, b, c, d, e), this.vertices = [], this.regionMap = [], this.xvalues = [], this.yvalues = [], this.yminmax = [], this.hightlightSpotId = null, this.lastShapeId = null, this.initTarget()
                },
                ...
                render: function() {
                    var a, e, f, g, h, i, j, k, l, m, n, o, p, q, s, t, u, w, x, y, z, A, B, C, D, E = this.options,
                        F = this.target,
                        G = this.canvasWidth,
                        H = this.canvasHeight,
                        I = this.vertices,
                        J = E.get("spotRadius"),
                        K = this.regionMap;
                    if (v._super.render.call(this) && (this.scanValues(), this.processRangeOptions(), B = this.xvalues, C = this.yvalues, this.yminmax.length && !(this.yvalues.length < 2))) {
                        ...
                        for (u = [], w = [], x = k.length, D = 0; D < x; D++) j = k[D], j.length && (E.get("fillColor") && (j.push([j[j.length - 1][0], g + H]), w.push(j.slice(0)), j.pop()), j.length > 2 && (j[0] = [j[0][0], j[1][1]]), u.push(j));
                        for (x = w.length, D = 0; D < x; D++) F.drawShape(w[D], E.get("fillColor"), E.get("fillColor")).append();
                        for (E.get("normalRangeMin") !== c && E.get("drawNormalOnTop") && this.drawNormalRange(h, g, H, G, e), x = u.length, D = 0; D < x; D++) F.drawShape(u[D], E.get("lineColor"), c, E.get("lineWidth")).append();
                        if (J && E.get("valueSpots"))
                            for (y = E.get("valueSpots"), y.get === c && (y = new r(y)), D = 0; D < t; D++)(A = y.get(C[D])) && F.drawCircle(h + b.round((B[D] - this.minx) * (G / a)), g + b.round(H - H * ((C[D] - this.miny) / e)), J, c, A).append();
            ...
            }), d.fn.sparkline.bar = w = f(d.fn.sparkline._base, u, {
                type: "bar",
                init: function(a, e, f, g, i) {
                    var m, n, o, p, q, s, t, u, v, x, y, z, A, B, C, D, E, F, G, H, I, J, K = parseInt(f.get("barWidth"), 10),
                        ...
                        P = 1 / 0,
                        Q = -1 / 0;
                    for (w._super.init.call(this, a, e, f, g, i), s = 0, t = e.length; s < t; s++) H = e[s], m = "string" == typeof H && H.indexOf(":") > -1, (m || d.isArray(H)) && (C = !0, m && (H = e[s] = k(H.split(":"))), H = l(H, null), n = b.min.apply(b, H), o = b.max.apply(b, H), n < P && (P = n), o > Q && (Q = o));
                    ...
                    for (s = 0, t = e.length; s < t; s++)
                        if (C)
                            for (D = e[s], e[s] = G = [], R[s] = 0, p[s] = S[s] = 0, E = 0, F = D.length; E < F; E++) null !== (H = G[E] = O ? h(D[E], A, B) : D[E]) && (H > 0 && (R[s] += H), P < 0 && Q > 0 ? H < 0 ? S[s] += b.abs(H) : p[s] += H : p[s] += b.abs(H - (H < 0 ? Q : P)), q.push(H));
                        else H = O ? h(e[s], A, B) : e[s], null !== (H = e[s] = j(H)) && q.push(H);
                    this.max = z = b.max.apply(b, q), this.min = y = b.min.apply(b, q), this.stackMax = Q = C ? b.max.apply(b, R) : z, this.stackMin = P = C ? b.min.apply(b, q) : y, f.get("chartRangeMin") !== c && (f.get("chartRangeClip") || f.get("chartRangeMin") < y) && (y = f.get("chartRangeMin")), f.get("chartRangeMax") !== c && (f.get("chartRangeClip") || f.get("chartRangeMax") > z) && (z = f.get("chartRangeMax")), this.zeroAxis = v = f.get("zeroAxis", !0), x = y <= 0 && z >= 0 && v ? 0 : 0 == v ? y : y > 0 ? y : z, this.xaxisOffset = x, u = C ? b.max.apply(b, p) + b.max.apply(b, S) : z - y, this.canvasHeightEf = v && y < 0 ? this.canvasHeight - 2 : this.canvasHeight - 1, y < x ? (J = C && z >= 0 ? Q : z, (I = (J - x) / u * this.canvasHeight) !== b.ceil(I) && (this.canvasHeightEf -= 2, I = b.ceil(I))) : I = this.canvasHeight, this.yoffset = I, d.isArray(f.get("colorMap")) ? (this.colorMapByIndex = f.get("colorMap"), this.colorMapByValue = null) : (this.colorMapByIndex = null, this.colorMapByValue = f.get("colorMap"), this.colorMapByValue && this.colorMapByValue.get === c && (this.colorMapByValue = new r(this.colorMapByValue))), this.range = u
                },
                ...
                calcColor: function(a, b, e) {
                    var f, g, h = this.colorMapByIndex,
                        ...
                        j = this.options;
                    return f = this.stacked ? j.get("stackedBarColor") : b < 0 ? j.get("negBarColor") : j.get("barColor"), 0 === b && j.get("zeroColor") !== c && (f = j.get("zeroColor")), i && (g = i.get(b)) ? f = g : h && h.length > e && (f = h[e]), d.isArray(f) ? f[a % f.length] : f
                },
                renderRegion: function(a, e) {
                    ...
                    for (j = z, k = 0; k < l; k++) {
                        ...
                        g = u > 0 ? b.floor(y * (b.abs(m - s) / u)) + 1 : 1, m < s || m === s && 0 === z ? (f = j, j += g) : (f = z - g, z -= g), h = this.calcColor(k, m, a), e && (h = this.calcHighlightColor(h, r)), t.push(w.drawRect(x, f, this.barWidth - 1, g - 1, h, h))
                    }
                    return 1 === t.length ? t[0] : t
                }
            }), d.fn.sparkline.tristate = x = f(d.fn.sparkline._base, u, {
                type: "tristate",
                init: function(a, b, e, f, g) {
                    var h = parseInt(e.get("barWidth"), 10),
                        i = parseInt(e.get("barSpacing"), 10);
                    x._super.init.call(this, a, b, e, f, g), this.regionShapes = {}, this.barWidth = h, this.barSpacing = i, this.totalBarWidth = h + i, this.values = d.map(b, Number), this.width = f = b.length * h + (b.length - 1) * i, d.isArray(e.get("colorMap")) ? (this.colorMapByIndex = e.get("colorMap"), this.colorMapByValue = null) : (this.colorMapByIndex = null, this.colorMapByValue = e.get("colorMap"), this.colorMapByValue && this.colorMapByValue.get === c && (this.colorMapByValue = new r(this.colorMapByValue))), this.initTarget()
                },
                ...
                renderRegion: function(a, c) {
                    var d, e, f, g, h, i, j = this.values,
                        k = this.options,
                        l = this.target;
                    if (d = l.falconHeight, f = b.round(d / 2), g = a * this.totalBarWidth, j[a] < 0 ? (h = f, e = f - 1) : j[a] > 0 ? (h = 0, e = f - 1) : (h = f - 1, e = 2), i = this.calcColor(j[a], a), null !== i) return c && (i = this.calcHighlightColor(i, k)), l.drawRect(g, h, this.barWidth - 1, e - 1, i, i)
                }
            }), d.fn.sparkline.discrete = y = f(d.fn.sparkline._base, u, {
                type: "discrete",
                init: function(a, e, f, g, h) {
                    y._super.init.call(this, a, e, f, g, h), this.regionShapes = {}, this.values = e = d.map(e, Number), this.min = b.min.apply(b, e), this.max = b.max.apply(b, e), this.range = this.max - this.min, this.width = g = "auto" === f.get("width") ? 2 * e.length : this.width, this.interval = b.floor(g / e.length), this.itemWidth = g / e.length, f.get("chartRangeMin") !== c && (f.get("chartRangeClip") || f.get("chartRangeMin") < this.min) && (this.min = f.get("chartRangeMin")), f.get("chartRangeMax") !== c && (f.get("chartRangeClip") || f.get("chartRangeMax") > this.max) && (this.max = f.get("chartRangeMax")), this.initTarget(), this.target && (this.lineHeight = "auto" === f.get("lineHeight") ? b.round(.3 * this.canvasHeight) : f.get("lineHeight"))
                },
                getRegion: function(a, c, d) {
            ...
            }), d.fn.sparkline.bullet = z = f(d.fn.sparkline._base, {
                type: "bullet",
                init: function(a, d, e, f, g) {
                    var h, i, j;
                    z._super.init.call(this, a, d, e, f, g), this.values = d = k(d), j = d.slice(), j[0] = null === j[0] ? j[2] : j[0], j[1] = null === d[1] ? j[2] : j[1], h = b.min.apply(b, d), i = b.max.apply(b, d), h = e.get("base") === c ? h < 0 ? h : 0 : e.get("base"), this.min = h, this.max = i, this.range = i - h, this.shapes = {}, this.valueShapes = {}, this.regiondata = {}, this.width = f = "auto" === e.get("width") ? "4.0em" : f, this.target = this.$el.simpledraw(f, g, e.get("composite")), d.length || (this.disabled = !0), this.initTarget()
                },
                getRegion: function(a, b, d) {
            ...
            }), d.fn.sparkline.pie = A = f(d.fn.sparkline._base, {
                type: "pie",
                init: function(a, c, e, f, g) {
                    var h, i = 0;
                    if (A._super.init.call(this, a, c, e, f, g), this.shapes = {}, this.valueShapes = {}, this.values = c = d.map(c, Number), "auto" === e.get("width") && (this.width = this.height), c.length > 0)
            ...
            }), d.fn.sparkline.box = B = f(d.fn.sparkline._base, {
                type: "box",
                init: function(a, b, c, e, f) {
                    B._super.init.call(this, a, b, c, e, f), this.values = d.map(b, Number), this.width = "auto" === c.get("width") ? "4.0em" : e, this.initTarget(), this.values.length || (this.disabled = 1)
                },
                getRegion: function() {
                    return 1
                },
                ...
                render: function() {
                    ...
                    if (B._super.render.call(this)) {
                        if (r.get("raw")) r.get("showOutliers") && p.length > 5 ? (d = p[0], a = p[1], f = p[2], g = p[3], h = p[4], j = p[5], k = p[6]) : (a = p[0], f = p[1], g = p[2], h = p[3], j = p[4]);
                            ...
                            for (a = j = c, l = 0; l < q; l++) a === c && p[l] > f - e * r.get("outlierIQR") && (a = p[l]), p[l] < h + e * r.get("outlierIQR") && (j = p[l]);
                            d = p[0], k = p[q - 1]
                        } else a = p[0], j = p[q - 1];
                ...
                _calculatefalconDims: function(a, b, c) {
                    var e;
                    e = this._pxregex.exec(b), this.falconHeight = e ? e[1] : d(c).height(), e = this._pxregex.exec(a), this.falconWidth = e ? e[1] : d(c).width()
                },
                _genShape: function(a, b) {
                    var c = K++;
                    return b.unshift(c), new E(this, c, a, b)
                },
                ...
                init: function(b, e, f, g) {
                    G._super.init.call(this, b, e, f), this.canvas = a.createElement("canvas"), f[0] && (f = f[0]), d.data(f, "_jqs_vcanvas", this), d(this.canvas).css({
                        display: "inline-block",
                        width: b,
                        height: e,
                        verticalAlign: "top"
                    }), this._insert(this.canvas, f), this._calculatefalconDims(b, e, this.canvas), this.canvas.width = this.falconWidth, this.canvas.height = this.falconHeight, this.interact = g, this.shapes = {}, this.shapeseq = [], this.currentTargetShapeId = c, d(this.canvas).css({
                        width: this.falconWidth,
                        height: this.falconHeight
                    })
                },
                ...
                reset: function() {
                    this._getContext().clearRect(0, 0, this.falconWidth, this.falconHeight), this.shapes = {}, this.shapeseq = [], this.currentTargetShapeId = c
                },
                _drawShape: function(a, b, d, e, f) {
                    var g, h, i = this._getContext(d, e, f);
                    for (i.beginPath(), i.moveTo(b[0][0] + .5, b[0][1] + .5), g = 1, h = b.length; g < h; g++) i.lineTo(b[g][0] + .5, b[g][1] + .5);
                ...
                render: function() {
                    var a, b, c, d = this.shapeseq,
                        ...
                        f = d.length,
                        g = this._getContext();
                    for (g.clearRect(0, 0, this.falconWidth, this.falconHeight), c = 0; c < f; c++) a = d[c], b = e[a], this["_draw" + b.type].apply(this, b.args);
                    this.interact || (this.shapes = {}, this.shapeseq = [])
                }
            }), H = f(F, {
                init: function(b, c, e) {
                    var f;
                    H._super.init.call(this, b, c, e), e[0] && (e = e[0]), d.data(e, "_jqs_vcanvas", this), this.canvas = a.createElement("span"), d(this.canvas).css({
                        display: "inline-block",
                        position: "relative",
                        overflow: "hidden",
                        width: b,
                        ...
                        padding: "0px",
                        verticalAlign: "top"
                    }), this._insert(this.canvas, e), this._calculatefalconDims(b, c, this.canvas), this.canvas.width = this.falconWidth, this.canvas.height = this.falconHeight, f = '<v:group coordorigin="0 0" coordsize="' + this.falconWidth + " " + this.falconHeight + '" style="position:absolute;top:0;left:0;width:' + this.falconWidth + "px;height=" + this.falconHeight + 'px;"></v:group>', this.canvas.insertAdjacentHTML("beforeEnd", f), this.group = d(this.canvas).children()[0], this.rendered = !1, this.prerender = ""
                },
                _drawShape: function(a, b, d, e, f) {
                    var g, h, i, j, k, l, m = [];
                    for (l = 0, k = b.length; l < k; l++) m[l] = b[l][0] + "," + b[l][1];
                    return g = m.splice(0, 1), f = f === c ? 1 : f, h = d === c ? ' stroked="false" ' : ' strokeWeight="' + f + 'px" strokeColor="' + d + '" ', i = e === c ? ' filled="false"' : ' fillColor="' + e + '" filled="true" ', j = m[0] === m[m.length - 1] ? "x " : "", '<v:shape coordorigin="0 0" coordsize="' + this.falconWidth + " " + this.falconHeight + '"  id="jqsshape' + a + '" ' + h + i + ' style="position:absolute;left:0px;top:0px;height:' + this.falconHeight + "px;width:" + this.falconWidth + 'px;padding:0px;margin:0px;"  path="m ' + g + " l " + m.join(", ") + " " + j + 'e"> </v:shape>'
                },
                _drawCircle: function(a, b, d, e, f, g, h) {
                    var i, j;
                    return b -= e, d -= e, i = f === c ? ' stroked="false" ' : ' strokeWeight="' + h + 'px" strokeColor="' + f + '" ', j = g === c ? ' filled="false"' : ' fillColor="' + g + '" filled="true" ', '<v:oval  id="jqsshape' + a + '" ' + i + j + ' style="position:absolute;top:' + d + "px; left:" + b + "px; width:" + 2 * e + "px; height:" + 2 * e + 'px"></v:oval>'
                },
                _drawPieSlice: function(a, d, e, f, g, h, i, j) {
                    ...
                    //return l === n && m === o && h - g < b.PI ? "" : (k = [d - f, e - f, d + f, e + f, l, m, n, o], p = i === c ? ' stroked="false" ' : ' strokeWeight="1px" strokeColor="' + i + '" ', q = j === c ? ' filled="false"' : ' fillColor="' + j + '" filled="true" ', '<v:shape coordorigin="0 0" coordsize="' + this.falconWidth + " " + this.falconHeight + '"  id="jqsshape' + a + '" ' + p + q + ' style="position:absolute;left:0px;top:0px;height:' + this.falconHeight + "px;width:" + this.falconWidth + 'px;padding:0px;margin:0px;"  path="m ' + d + "," + e + " wa " + k.join(", ") + ' x e"> </v:shape>')
                },
                _drawRect: function(a, b, c, d, e, f, g) {
                    return this._drawShape(a, [
                        [b, c],
                ...
                replaceWithShapes: function(a, b) {
                    var c, e = d("#jqsshape" + a[0]),
                        f = "",
                        g = b.length;
                    for (c = 0; c < g; c++) f += this["_draw" + b[c].type].apply(this, b[c].args);
